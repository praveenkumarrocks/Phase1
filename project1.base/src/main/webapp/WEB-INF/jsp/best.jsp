...
<html>
<head>
<title>Best Deals : Project 1</title>
				...
				<div class="new-product">
					<div class="new-product-top">
						<ul class="product-top-list">
							...
							<li><a href="/project1/best">Best Buy</a>&nbsp;<span>&gt;</span></li>
							<li><span class="act">Best Sales</span>&nbsp;</li>
						</ul>
						<p class="back">
							<a href="/project1/index">Back to Previous</a>
						</p>
						<div class="clearfix"></div>
					</div>
					<div class="mens-toolbar">
						<div class="sort">
							<div class="sort-by">
								...
								</select> <a href=""><img src="images/arrow2.gif" alt="" class="v-middle"></a>
							</div>
						</div>
					...
					<div id="cbp-vm" class="cbp-vm-switcher cbp-vm-view-grid">
						...
						<ul>
							<li>
								...
								<div class="cbp-vm-details">Silver beet shallot wakame tomatillo salsify mung bean beetroot groundnut.</div>
								<a
							...
							<li><a class="cbp-vm-image" href="single.html">
									<div class="view view-first">
										<div class="inner_content clearfix">
											<div class="product_image">
												<img src="images/bb3.png" class="img-responsive" alt="" />
												<div class="mask">
													<div class="info">Quick View</div>
												</div>
												<div class="product_container">
