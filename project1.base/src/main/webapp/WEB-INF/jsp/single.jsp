			...
			<div class="new-product">
				<div class="new-product-top">
					<ul class="product-top-list">
						...
						<li><span class="act">Retro Bicycle #2</span>&nbsp;</li>
					</ul>
				     ...
				     <ul id="etalage">
							<li>
								<a href="optionallink.html">
									<img class="etalage_thumb_image" src="images/spb1.jpg" class="img-responsive" />
									<img class="etalage_source_image" src="images/spbm1.jpg" class="img-responsive" />
								</a>
							</li>
							<li>
								<a href="optionallink.html">
									<img class="etalage_thumb_image" src="images/spb2.jpg" class="img-responsive" />
									<img class="etalage_source_image" src="images/spbm2.jpg" class="img-responsive" />
								</a>
							</li>
							<li>
								<a href="optionallink.html">
									<img class="etalage_thumb_image" src="images/spb3.jpg" class="img-responsive" />
									<img class="etalage_source_image" src="images/spbm3.jpg" class="img-responsive" />
								</a>
							</li>
							<li>
								<a href="optionallink.html">
									<img class="etalage_thumb_image" src="images/spb4.jpg" class="img-responsive" />
									<img class="etalage_source_image" src="images/spbm4.jpg" class="img-responsive" />
								</a>
							</li>
					</ul>
				</div>
				<div class="cont1 span_2_of_al">
					<h3>Retro Bicycle #2</h3>
					<ul class="ratings">
						<li>
							<a href="">Review 1 Add Review</a>
						</li>
						<li>
							<a href="">
					...
					<div class="price_single">
					  <span class="reducedfrom">1 219.99$</span>
					  <span class="actual">899.99$</span><a href="#">click for offer</a>
					</div>
